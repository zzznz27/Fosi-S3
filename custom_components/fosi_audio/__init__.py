...
REMOVED_ENTITY_SUFFIXES = ("_like", "_dislike", "_stop_streaming")
...
def _async_remove_stale_entities(hass: HomeAssistant, entry: ConfigEntry) -> None:
    ...
    for entity in er.async_entries_for_config_entry(registry, entry.entry_id):
        ...
        # Named as well as domain-checked, so an entity that goes away while
        # its platform stays is still swept.
